...
class UI:
    ...
    def _show_budget_view(self):
        self._hide_view()
        self._view = BudgetView(self._root, self._show_add_expense_view, self._show_login, self._show_plot_view)
        self._view.pack()
    ...
    def _show_plot_view(self):
        self._hide_view()
        self._view = PlotView(self._root, self._show_budget_view)
        self._view.pack()
